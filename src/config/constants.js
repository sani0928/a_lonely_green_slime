...
export const BOSS_SPAWN_KILL_STEP_INCREMENT = 15;
...
export const BOSS_CELL_HIT_COOLDOWN_SEC = 0.09;
...
export const BOSS_HP_EARLY_STEP = 400;
export const BOSS_HP_EARLY_COUNT = 10;
export const BOSS_HP_LATE_STEP = 600;
export const BOSS_SCALING_GROUP_SIZE = 5;
export const BOSS_DAMAGE_TAKEN_MULTIPLIER_STEP = 0.1;
export const BOSS_DAMAGE_TAKEN_MULTIPLIER_MIN = 0.2;
export const BOSS_PATTERN_COOLDOWN_MULTIPLIER_STEP = 0.1;
export const BOSS_PATTERN_COOLDOWN_MULTIPLIER_MIN = 0.2;
